...
console.log(selectedColor+'=='+selectedSize+ JSON.stringify(product))
    //product({...CartContext,color : selectedColor})
    //product.push({size : selectedColor})
    // product[0].color = selectedSize;
    // product[0].size = selectedSize;
    addToCartItem({...product, color : selectedColor, size : selectedSize});
