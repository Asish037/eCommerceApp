    ...
    <LinearGradient colors={COLORS.gradient} style={styles.container}>
      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.bodyContainer}>
          ...
          <Text style={[styles.subHead, {color: COLORS.blue}]}>
            What's new?
          </Text>
        </View>

        <Text style={styles.subHead}>
          This Privacy Policy describes how W2E Tourism LLP and its affiliates
          (collectively "
        </Text>

        <Text style={styles.subHead}>
          W2E Tourism LLP, we, our, us”) collect, use, share, protect or
          otherwise process your information/ personal data through our website
          www.xipper.in (hereinafter referred to as Platform). Please note that
        ...
        <Text style={styles.subHead}>
          ...
          relationship and related information provided from time to time. Some
          ...
          as proof of identity or address. Some of the
        </Text>

        <Text style={styles.subHead}>
          sensitive personal data may be collected with your consent, such as
          your bank account or credit or debit card or other payment instrument
          information or biometric information such as your facial features or
          physiological information (in order to enable use of certain features
          when opted for, available on the Platform) etc all of the above being
          in accordance with applicable law(s) You always have the option to not
          ...
          receive an email, a call from a person/association claiming to be W2E
          Tourism LLP seeking any personal data like debit/credit card PIN,
        ...
        <Text style={styles.subHead}>
          Usage – We use personal data to provide the services you request. To
          the extent we use your personal data to market to you, we will provide
          you the ability to opt-out of such uses. We use your personal data to
        ...
        <Text style={styles.subHead}>
          ...
          the time of collection of information. You understand that your access
          to these products/services may be affected in the event permission is
          not provided to us.
        </Text>

        <Text style={styles.subHead}>
          Sharing – We may share your personal data internally within our group
          entities, our other corporate entities, and affiliates to provide you
          access to the services and products offered by them. These entities
          and affiliates may market to you as a result of such sharing unless
          you explicitly opt-out. We may disclose personal data to third parties
        ...
        <Text style={styles.subHead}>
          Security Precautions – To protect your personal data from unauthorised
          access or disclosure, loss or misuse we adopt reasonable security
          practices and procedures. Once your information is in our possession
          or whenever you access your account information, we adhere to our
        ...
        <Text style={styles.subHead}>
          Data Deletion and Retention – You have an option to delete your
          account by visiting your profile and settings on our Platform, this
          action would result in you losing all information related to your
          account. You may also write to us at the contact information provided
          below to assist you with these requests. We may in event of any
          pending grievance, claims, pending shipments or any other services we
          may refuse
        </Text>

        <Text style={styles.subHead}>
          or delay deletion of the account. Once the account is deleted, you
          will lose access to the account. We retain your personal data
          information for a period no longer than is required for the purpose
        ...
        <Text style={styles.subHead}>
          Your Rights – You may access, rectify, and update your personal data
        ...
        <Text style={styles.subHead}>
          ...
          you consent to the collection, use, storage, disclosure and otherwise
          processing of your information on the Platform in accordance with this
          Privacy Policy. If you disclose to us any personal data relating to
          ...
          Policy. You, while providing your personal data over the Platform or
          ...
          have an option to withdraw your consent that you have already provided
          by writing to the Grievance Officer at the contact information
          provided below. Please mention “Withdrawal of consent for processing
          personal data” in your subject line of your communication. We may
          verify such requests before acting on our request. However, please
          note that your withdrawal of consent will not be retrospective and
          will be in accordance with the Terms of Use, this Privacy Policy, and
        ...
        <Text style={styles.subHead}>
          ...
          periodically for changes. We may update this Privacy Policy to reflect
          changes to our information practices. We may alert / notify you about
